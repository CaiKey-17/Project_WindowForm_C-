    ...
    public partial class Owner : Form
    {
        ...
        private void ResetButtonFillColor()
        {
            if (panelMenu.BackColor == Color.FromArgb(50, 50, 50))
            {
                ...
                labelBar4.ForeColor = labelBar1.ForeColor = labelBar2.ForeColor = labelBar3.ForeColor
                    ...
                    = labelBar9.ForeColor = labelBar10.ForeColor = Color.Cyan;
                ...
                labelBar4.BackColor = labelBar1.BackColor = labelBar2.BackColor = labelBar3.BackColor
                    ...
                    = labelBar9.BackColor = labelBar10.BackColor = Color.FromArgb(50, 50, 50);

                btnInformation.Image = Properties.Resources.people1;
                btnStaff.Image = Properties.Resources.next11;
                btnPatient.Image = Properties.Resources.next11;
                btnCalendar.Image = Properties.Resources.calendar;
                btnMedicalInstruments.Image = Properties.Resources.firstkit1;
                btnTransact.Image = Properties.Resources.expenses1;
                btnIncome.Image = Properties.Resources.next11;
                btnSpending.Image = Properties.Resources.next11;
                btnStatistical.Image = Properties.Resources.trend;
                btnSalary.Image = Properties.Resources.salary1;
            }
            else
            {
                btnInformation.FillColor = Color.White;
                btnStaff.FillColor = Color.White;
                btnPatient.FillColor = Color.White;
                btnCalendar.FillColor = Color.White;
                btnMedicalInstruments.FillColor = Color.White;
                btnTransact.FillColor = Color.White;
                btnIncome.FillColor = Color.White;
                btnSpending.FillColor = Color.White;
                btnStatistical.FillColor = Color.White;
                ...
                labelBar4.BackColor = labelBar1.BackColor = labelBar2.BackColor = labelBar3.BackColor
                    = labelBar5.BackColor = labelBar6.BackColor = labelBar7.BackColor = labelBar8.BackColor
                    = labelBar9.BackColor = labelBar10.BackColor = Color.White;
                ...
                //ảnh
                btnInformation.Image = Properties.Resources.people;
                btnStaff.Image = Properties.Resources.next1;
                btnPatient.Image = Properties.Resources.next1;
                btnCalendar.Image = Properties.Resources.calendar1;
                btnMedicalInstruments.Image = Properties.Resources.firstkit;
                btnTransact.Image = Properties.Resources.expenses;
                btnIncome.Image = Properties.Resources.next1;
                btnSpending.Image = Properties.Resources.next1;
                btnStatistical.Image = Properties.Resources.trend1;
                btnSalary.Image = Properties.Resources.salary;
            }
        }
        ...
        private void btnStaff_Click(object sender, EventArgs e)
        {
            ...
            if (activeForm is Owner_Staff)
            {
                ...
                btnInformation.Image = (panelMenu.BackColor == Color.Black) ? Properties.Resources.people1 : Properties.Resources.people1;
                //
                ...
                btnStaff.Image = (panelMenu.BackColor == Color.Black) ? Properties.Resources.next11 : Properties.Resources.next11;
                //
        ...
        private void btnPatient_Click(object sender, EventArgs e)
        {
            ...
            if (activeForm is Owner_Patient)
            {
                ...
                btnPatient.Image = (panelMenu.BackColor == Color.Black) ? Properties.Resources.next11 : Properties.Resources.next11;
                //
        ...
        private void btnMedicalInstruments_Click(object sender, EventArgs e)
        {
            ...
            if (activeForm is Owner_MedicalInstruments)
            {
                ...
                btnMedicalInstruments.Image = (panelMenu.BackColor == Color.Black) ? Properties.Resources.firstkit1 : Properties.Resources.firstkit1;
                //
        ...
        private void btnIncome_Click(object sender, EventArgs e)
        {
            ...
            if (activeForm is Owner_Income)
            {
                ...
                btnTransact.Image = (panelMenu.BackColor == Color.Black) ? Properties.Resources.expenses1 : Properties.Resources.expenses1;
                //
                ...
                btnIncome.Image = (panelMenu.BackColor == Color.Black) ? Properties.Resources.next11 : Properties.Resources.next11;
                //
        ...
        private void btnSpending_Click(object sender, EventArgs e)
        {
            ...
            if (activeForm is Owner_Spending)
            {
                ...
                btnSpending.Image = (panelMenu.BackColor == Color.Black) ? Properties.Resources.next11 : Properties.Resources.next11;
                //
        ...
        private void btnStatistical_Click(object sender, EventArgs e)
        {
            ...
            if (activeForm is Owner_Statistical)
            {
                ...
                btnStatistical.Image = (panelMenu.BackColor == Color.Black) ? Properties.Resources.trend : Properties.Resources.trend;
                //
        ...
        private void btnSalary_Click(object sender, EventArgs e)
        {
            ...
            if (activeForm is Owner_Salary)
            {
                ...
                btnSalary.Image = (panelMenu.BackColor == Color.Black) ? Properties.Resources.salary1 : Properties.Resources.salary1;
                //
        ...
        {
            string url = "nhakhoamothaiba.000webhostapp.com";

            // Sử dụng ProcessStartInfo để thiết lập thông tin về URL
