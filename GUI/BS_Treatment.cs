    ...
    public partial class BS_Treatment : Form
    {
        ...
        public void ChangeLanguage(string language)
        {
            if (language == "Vietnam")
            {
                ...
                btnUpdate1.Text = btnUpdate2.Text = "Sửa";
                guna2Button9.Text = btnDelete.Text = "Xóa";
                btnDone1.Text = "Hoàn tất điều trị";
                guna2Button10.Text = "Phiếu theo dõi điều trị";
                btnBill.Text = "Xem bệnh án";
        ...
        private void resetButton()
        {
            ...
            if (guna2DataGridView1.BackgroundColor == Color.FromArgb(50, 50, 50))
            {
                ...
                guna2Button10.Image = Properties.Resources.invoice1;


                //Dụng cụ
                btnTool.ForeColor = Color.White;
                btnTool.FillColor = Color.FromArgb(50, 50, 50);
                btnTool.Image = Properties.Resources.dentisttools1;

                guna2Button3.FillColor = btnAdd.FillColor = btnUpdate1.FillColor = btnDelete.FillColor = guna2Button7.FillColor =
                guna2Button4.FillColor = btnDone1.FillColor = guna2Button5.FillColor = btnUpdate2.FillColor =
            ...
            else
            {
                ...
                guna2Button10.FillColor = Color.FromArgb(63, 220, 254);
                guna2Button10.ForeColor = Color.Black;
                guna2Button10.Image = Properties.Resources.invoice;

                //Dụng cụ
                btnTool.ForeColor = Color.Black;
                btnTool.FillColor = Color.FromArgb(63, 220, 254);
                btnTool.Image = Properties.Resources.dentisttools;

                guna2Button2.FillColor = guna2Button6.FillColor = btnDone.FillColor = guna2Button3.FillColor = btnAdd.FillColor = guna2Button7.FillColor =
                guna2Button4.FillColor = btnDone1.FillColor = guna2Button5.FillColor = Color.FromArgb(64, 165, 93);

                btnDelete.FillColor  = Color.FromArgb(209, 0, 0);
            }
        ...
        private void btnPatient_Click(object sender, EventArgs e)
        {
            ...
            hideChildForm();
            btnPatient.FillColor = (guna2DataGridView1.BackgroundColor == Color.FromArgb(50, 50, 50)) ? Color.FromArgb(4, 55, 102) : Color.FromArgb(7, 125, 4);
            btnPatient.ForeColor = (guna2DataGridView1.BackgroundColor == Color.FromArgb(50, 50, 50)) ? Color.White : Color.White;
            btnPatient.Image = (guna2DataGridView1.BackgroundColor == Color.FromArgb(50, 50, 50)) ? Properties.Resources.patient : Properties.Resources.patient;
        }
        ...
        private void btnService_Click(object sender, EventArgs e)
        {
            ...
            resetButton();
            hideChildForm();
            btnService.FillColor = (guna2DataGridView1.BackgroundColor == Color.FromArgb(50, 50, 50)) ? Color.FromArgb(4, 55, 102) : Color.FromArgb(7, 125, 4);
            btnService.ForeColor = (guna2DataGridView1.BackgroundColor == Color.FromArgb(50, 50, 50)) ? Color.White : Color.White;
            btnService.Image = (guna2DataGridView1.BackgroundColor == Color.FromArgb(50, 50, 50)) ? Properties.Resources.examination1 : Properties.Resources.examination1;
        }
        ...
        private void btnPrescription_Click(object sender, EventArgs e)
        {
            ...
            resetButton();
            hideChildForm();
            btnPrescription.FillColor = (guna2DataGridView1.BackgroundColor == Color.FromArgb(50, 50, 50)) ? Color.FromArgb(4, 55, 102) : Color.FromArgb(7, 125, 4);
            btnPrescription.ForeColor = (guna2DataGridView1.BackgroundColor == Color.FromArgb(50, 50, 50)) ? Color.White : Color.White;
            btnPrescription.Image = (guna2DataGridView1.BackgroundColor == Color.FromArgb(50, 50, 50)) ? Properties.Resources.medicine : Properties.Resources.medicine;
        }
        ...
        private void btnTool_Click(object sender, EventArgs e)
        {
            ...
            btnTool.Image = (guna2DataGridView1.BackgroundColor == Color.FromArgb(50, 50, 50)) ? Properties.Resources.dentisttools1 : Properties.Resources.dentisttools1;
        }
        ...
        private void btnDone_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Thay đổi số lượng thành công");
            HideSubMenu(panePatient);
            showSubMenu(panelPrescription);
            HideSubMenu(panelTool);
            HideSubMenu(panelService);
        ...
        private void btnDone1_Click(object sender, EventArgs e)
        {
            ...
            btnPatient.FillColor = (guna2DataGridView1.BackgroundColor == Color.FromArgb(50, 50, 50)) ? Color.FromArgb(4, 55, 102) : Color.FromArgb(7, 125, 4);
            btnPatient.ForeColor = (guna2DataGridView1.BackgroundColor == Color.FromArgb(50, 50, 50)) ? Color.White : Color.White;
            btnPatient.Image = (guna2DataGridView1.BackgroundColor == Color.FromArgb(50, 50, 50)) ? Properties.Resources.dentisttools1 : Properties.Resources.dentisttools1;
            _dataSet = BLL.Doctor.DaTiepNhan(DateTime.Now, Static.getUser().GetMaNhanVien());
            guna2DataGridView1.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            guna2DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.AllCells;
            guna2DataGridView1.DataSource = _dataSet.Tables[0];
