    ...
    public partial class Owner_MedicalInstruments : Form
    {
        ...
        private void resetButton()
        {
            if(guna2DataGridView1.BackgroundColor == Color.FromArgb(50, 50, 50))
            {
                ...
                btnMedicine.Image = Properties.Resources.medicine;

                btnMaterial.ForeColor = Color.White;
                btnMaterial.FillColor = Color.FromArgb(50, 50, 50);
                btnMaterial.Image = Properties.Resources.dentisttools1;

                btnService.ForeColor = Color.White;
                btnService.FillColor = Color.FromArgb(50, 50, 50);
                btnService.Image = Properties.Resources.examination1;

                tbSearch.FillColor = btnSearch.FillColor = btnAdd.FillColor = btnUpdate1.FillColor = Color.FromArgb(50, 50, 50);
            }
            else
            {
                btnMedicine.ForeColor = Color.Black;
                btnMedicine.FillColor = Color.FromArgb(63, 220, 254);
                btnMedicine.Image = Properties.Resources.medicine1;

                btnMaterial.ForeColor = Color.Black;
                btnMaterial.FillColor = Color.FromArgb(63, 220, 254);
                btnMaterial.Image = Properties.Resources.dentisttools;
                ...
                tbSearch.FillColor = btnUpdate1.FillColor = Color.White;
                btnSearch.FillColor = Color.FromArgb(94, 148, 255);
                btnAdd.FillColor = Color.FromArgb(64, 165, 93);
            }
        }
        ...
        private void btnMedicine_Click(object sender, EventArgs e)
        {
            ...
            btnMedicine.Image = (guna2DataGridView1.BackgroundColor == Color.FromArgb(50, 50, 50)) ? Properties.Resources.medicine : Properties.Resources.medicine;
            trangthai = 0;
            change();
        ...
        {
            resetButton();
            btnMaterial.FillColor = (guna2DataGridView1.BackgroundColor == Color.FromArgb(50, 50, 50)) ? Color.FromArgb(4, 55, 102) : Color.FromArgb(7, 125, 4);
            btnMaterial.ForeColor = (guna2DataGridView1.BackgroundColor == Color.FromArgb(50, 50, 50)) ? Color.White : Color.White;
            btnMaterial.Image = (guna2DataGridView1.BackgroundColor == Color.FromArgb(50, 50, 50)) ? Properties.Resources.dentisttools1 : Properties.Resources.dentisttools1;
            trangthai = 1;
            change();
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            if(guna2DataGridView1.SelectedRows.Count > 0)
            {
                if(trangthai == 2)
                {
                    ...
                    DialogResult result = MessageBox.Show("Bạn có muốn chọn dịch vụ?", "Đồng ý", MessageBoxButtons.YesNo);
                ...
                if(trangthai == 0)
                {
                    ...
                    DialogResult result = MessageBox.Show("Bạn có muốn chọn thuốc?", "Đồng ý", MessageBoxButtons.YesNo);
                    if (result == DialogResult.Yes)
                    {
                        truyenThuoc(list);
                        this.Close();
