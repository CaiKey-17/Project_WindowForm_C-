...
namespace Project_CNPM
{
    public partial class Owner_Home : Form
    {
        ...
        public Owner_Home()
        {
            ...
            btn4 = new Rectangle(btnMedicalInstruments.Location, btnMedicalInstruments.Size);
            btn5 = new Rectangle(btnIncome.Location, btnIncome.Size);
            btn6 = new Rectangle(btnSpending.Location, btnSpending.Size);
            btn7 = new Rectangle(btnStatistical.Location, btnStatistical.Size);
            btn8 = new Rectangle(btnSalary.Location, btnSalary.Size);
        }
        ...
        public void ChangeLanguage(string language)
        {
            if (language == "Vietnam")
            {
                ...
                btnMedicalInstruments.Text = "QUẢN LÝ VẬT TƯ - DỤNG CỤ Y TẾ";
        ...
        public void ChangeBackgroundColor(Color color, Color color2)
        {
            ...
            {
                btnStaff.FillColor = btnStaff.FillColor2 = btnMedicalInstruments.FillColor = btnMedicalInstruments.FillColor2 = btnIncome.FillColor = btnIncome.FillColor2 =
                    btnSalary.FillColor = btnSalary.FillColor2 = btnPatient.FillColor = btnPatient.FillColor2 = btnCalendar.FillColor = btnCalendar.FillColor2 = btnSpending.FillColor = 
            ...
            else
            {
                ...
                btnPatient.FillColor = btnPatient.FillColor2 = btnCalendar.FillColor = btnCalendar.FillColor2 = btnSpending.FillColor = btnSpending.FillColor2 =
        ...
        private void Form1_Resiz(object sender, EventArgs e)
        {
            ...
            resize_Control(btnMedicalInstruments, btn4);
            resize_Control(btnIncome, btn5);
            resize_Control(btnSpending, btn6);
            resize_Control(btnStatistical, btn7);
            resize_Control(btnSalary, btn8);
        }
